...
const CustomMap: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-4 md:gap-0">
      {/* Map Container */}
      <div className="relative w-full h-80 sm:h-96 md:h-[500px] lg:h-[600px] rounded-2xl sm:rounded-3xl overflow-hidden">
        {/* Map Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-light-gold/40 via-white to-light-gold/20">
        ...
        <motion.div
          className="absolute top-3 sm:top-6 right-3 sm:right-6 bg-white/95 backdrop-blur-md rounded-xl sm:rounded-2xl shadow-lg p-2 sm:p-4 border border-primary/20 max-w-[140px] sm:max-w-none z-10"
      ...
      {/* Info Panel - Below map on mobile, overlaid on desktop */}
      <motion.div
        className="w-full md:absolute md:bottom-3 md:left-3 md:right-3 md:w-auto md:max-w-md bg-white/95 backdrop-blur-md rounded-xl sm:rounded-2xl shadow-xl p-3 sm:p-6 border border-primary/20 md:z-20"
        layout
      >
        <motion.div
          key={activeMarker}
